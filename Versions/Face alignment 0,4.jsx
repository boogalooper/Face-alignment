...
const rotateMode = 1 // 0 - поворот головы выключен, 1 - поворот головы включен
const debugMode = 0 // 0 - выключен, 1 - отрисовывать найденные границы лица и центр позиционирования
...
function getFaceBounds(selectedLayers) {
    ...
    function getRelativeBounds(id, measurerment) {
        ...
        this.left = f.left + this.offcet + shiftL
        this.right = f.right - this.offcet - shiftR
